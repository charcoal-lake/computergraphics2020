...
5. shader
*/
let deer_posx=0, deer_posy=0, deer_rotate=0;
...
function draw(){
    ...
    cam_dx = map(mouseX, -width, width, -180, 180);
    ...
    if(radio.value() == 'first person'){
        perspective(PI/3.0);
        camera(deer_posx-cam_tx/10, deer_posy-cam_ty/10, -150, cam_tx, cam_ty, cam_tz-100, 0, 0, 1);
    }
    ...
    if(radio.value()=='first person')
        deer_rotate = -mouseX+width/2;
    test_deer.move(deer_posx, deer_posy, deer_rotate/4);
...
function moveDeer(option){
    if(keyIsPressed){
        if(option == 'first person'){
            ...
            if(key == 'w' || key == 'W'){
                deer_posx += move_dist;
                if(deer_rotate>0) deer_rotate -=5;
                else if (deer_rotate<0) deer_rotate +=5;
            }
            else if(key == 's' || key == 'S'){
                deer_posx -= move_dist;
                if(deer_rotate>180) deer_rotate -=5;
                else if (deer_rotate<180) deer_rotate +=5;
            }
            else if(key == 'a' || key == 'A'){
                deer_posy -= move_dist;
                if(deer_rotate>-90) deer_rotate -=5;
                else if(deer_rotate<-90) deer_rotate +=5;
            }
            else if(key == 'd' || key == 'D'){
                deer_posy += move_dist;
                if(deer_rotate<90) deer_rotate +=5;
